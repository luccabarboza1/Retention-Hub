...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    {{-- Actions / Back --}}
    <div class="flex items-center justify-between shrink-0 bg-slate-50/50 dark:bg-slate-800/50 px-4 py-3 rounded-xl border border-slate-100 dark:border-slate-800/80 backdrop-blur-sm">
