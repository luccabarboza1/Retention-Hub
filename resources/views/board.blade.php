...
<div x-data="board()" class="h-full flex flex-col">
    ...
    {{-- Board Toolbar / Stats --}}
    <div class="flex items-center justify-between mb-6 shrink-0 bg-slate-50/60 dark:bg-slate-900/60 p-4 rounded-xl border border-slate-100/80 dark:border-slate-800/80 backdrop-blur-sm">
        <div>
            ...
            <div class="flex items-center justify-between mb-3 px-1">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <form method="POST" action="{{ route('columns.destroy', $col) }}"
                          @submit.prevent="$dispatch('open-confirm', { title: 'Excluir etapa', message: 'Deseja excluir a etapa \"{{ addslashes($col->name) }}\"? Os cards não serão removidos.', form: $el })">
                        @csrf @method('DELETE')
