...
<div class="max-w-3xl mx-auto space-y-6" x-data="{ adding: false }">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-2 mt-1">
                        @foreach(['*' => 'Todos os eventos', 'customer.created' => 'Cliente criado', 'customer.updated' => 'Cliente atualizado', 'customer.deleted' => 'Cliente excluído', 'card.created' => 'Card criado', 'card.updated' => 'Card atualizado', 'card.finished' => 'Card encerrado', 'card.deleted' => 'Card excluído'] as $val => $label)
    ...
    <div class="bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
            @foreach(['customer.created' => 'Cliente cadastrado pela primeira vez', 'customer.updated' => 'Dados do cliente atualizados', 'customer.deleted' => 'Cliente excluído do sistema', 'card.created' => 'Card criado via interface ou API', 'card.updated' => 'Card editado (campos, status, etapa)', 'card.finished' => 'Card encerrado (Retido ou Churn)', 'card.deleted' => 'Card excluído permanentemente'] as $evt => $desc)
