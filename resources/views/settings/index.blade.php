...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <a href="{{ route('settings.general') }}"
           class="group bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 shadow-premium hover:shadow-premium-hover hover:border-brand-300 dark:hover:border-brand-800 transition-all duration-200 flex items-start gap-4">
            ...
            <svg class="w-4 h-4 text-slate-300 dark:text-slate-600 group-hover:text-brand-400 transition-colors shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
