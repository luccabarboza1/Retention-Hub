...
return [
    ...
    'info' => [
        'version' => '1.0.0',
        'description' => 'API REST interna do Retention Hub — plataforma de Ouvidoria e Retenção da Umbler. Todos os endpoints exigem autenticação via `X-Api-Token` header (além do Basic Auth do proxy).',
    ],

    'ui' => [
        'title' => 'Retention Hub — API Reference',
    ],
